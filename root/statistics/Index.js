...
const Index = ({
  ...
  const nonGroupCount = stats.data['count.artist.type.null'] + stats.data['count.artist.type.person'] + stats.data['count.artist.type.character'] + stats.data['count.artist.type.other'];
      ...
      <table className="database-statistics">
        <tbody>
          ...
          <tr>
            ...
            <td
              colSpan="3"
            >{formatCount(stats.data['count.releasegroup'], $c)}
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td
              colSpan="3"
            >{formatCount(stats.data['count.recording'], $c)}
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td
              colSpan="3"
            >{formatCount(stats.data['count.instrument'], $c)}
            </td>
          </tr>
          <tr>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{formatCount(stats.data['count.cdstub.submitted'], $c)}</td>
            <td>{'/'}</td>
            <td> {formatCount(stats.data['count.cdstub'], $c)}</td>
          </tr>
          <tr>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{formatCount(stats.data['count.isrc.all'], $c)}</td>
            <td>{'/'}</td>
            <td>{formatCount(stats.data['count.isrc'], $c)}</td>
          </tr>
          <tr>
            <th>{l_statistics('ISWCs (all / unique):')}</th>
            <td>{formatCount(stats.data['count.iswc.all'], $c)}</td>
            <td>{'/'}</td>
            <td>{formatCount(stats.data['count.iswc'], $c)}</td>
          </tr>
          <tr>
      ...
      <table className="database-statistics">
        <tbody>
          ...
          <tr>
            ...
            <td>{formatCount(nonGroupCount, $c)}</td>
            <td />
          </tr>
          <tr>
            <th />
            ...
            <td>{formatPercentage(stats.data['count.artist.gender.male'] / nonGroupCount, 1, $c)}</td>
          </tr>
          <tr>
            <th />
            <th>{l_statistics('Female:')}</th>
            <td>{formatCount(stats.data['count.artist.gender.female'], $c)}</td>
            <td>{formatPercentage(stats.data['count.artist.gender.female'] / nonGroupCount, 1, $c)}</td>
          </tr>
          <tr>
            <th />
            <th>{l_statistics('Other gender:')}</th>
            <td>{formatCount(stats.data['count.artist.gender.other'], $c)}</td>
            <td>{formatPercentage(stats.data['count.artist.gender.other'] / nonGroupCount, 1, $c)}</td>
          </tr>
          <tr>
            <th />
            <th>{l_statistics('Gender not applicable:')}</th>
            <td>{formatCount(stats.data['count.artist.gender.not_applicable'], $c)}</td>
            <td>{formatPercentage(stats.data['count.artist.gender.not_applicable'] / nonGroupCount, 1, $c)}</td>
          </tr>
          <tr>
            <th />
            <th>{l_statistics('with no gender set:')}</th>
            <td>{formatCount(stats.data['count.artist.gender.null'], $c)}</td>
            <td>{formatPercentage(stats.data['count.artist.gender.null'] / nonGroupCount, 1, $c)}</td>
          </tr>
        </tbody>
      </table>
        ...
        <tbody>
          ...
          {oneToNine.map(num => (
            <tr key={num}>
              <th />
              <th />
              <th>{ln_statistics('with {num} disc ID:', 'with {num} disc IDs:', num, {num: num})}</th>
