...
const linkedEntities: LinkedEntitiesT = Object.seal({
  area:                           ({}: {[areaId: number]: AreaT}),
  area_alias_type:                ({}: {[typeId: number]: AreaAliasTypeT}),
  area_type:                      ({}: {[areaTypeId: number]: AreaTypeT}),
  artist:                         ({}: {[artistId: number]: ArtistT}),
  artist_alias_type:              ({}: {[typeId: number]: ArtistAliasTypeT}),
  artist_type:                    ({}: {[artistId: number]: ArtistTypeT}),
  collection_type:                (
    {}: {[collectionTypeId: number]: CollectionTypeT}
  ),
  edit:                           ({}: {[editId: number]: EditWithIdT}),
  editor:                         ({}: {[editorId: number]: EditorT}),
  event:                          ({}: {[eventId: number]: EventT}),
  event_alias_type:               ({}: {[typeId: number]: EventAliasTypeT}),
  event_type:                     ({}: {[eventTypeId: number]: EventTypeT}),
  genre:                          ({}: {[genreId: number]: GenreT}),
  genre_alias_type:               ({}: {[typeId: number]: GenreAliasTypeT}),
  instrument:                     ({}: {[instrumentId: number]: InstrumentT}),
  instrument_alias_type:          (
    {}: {[typeId: number]: InstrumentAliasTypeT}
  ),
  instrument_type:                (
  ...
  label:                          ({}: {[labelId: number]: LabelT}),
  label_alias_type:               ({}: {[typeId: number]: LabelAliasTypeT}),
  label_type:                     ({}: {[labelTypeId: number]: LabelTypeT}),
  language:                       ({}: {[languageId: number]: LanguageT}),
  link_attribute_type:            (
    {}: {[linkAttributeTypeIdOrGid: StrOrNum]: LinkAttrTypeT}
  ),
  link_type:                      (
  ...
  place:                          ({}: {[placeId: number]: PlaceT}),
  place_alias_type:               ({}: {[typeId: number]: PlaceAliasTypeT}),
  place_type:                     ({}: {[placeTypeId: number]: PlaceTypeT}),
  recording:                      ({}: {[recordingId: number]: RecordingT}),
  recording_alias_type:           (
    {}: {[typeId: number]: RecordingAliasTypeT}
  ),
  release:                        ({}: {[releaseId: number]: ReleaseT}),
  release_alias_type:             ({}: {[typeId: number]: ReleaseAliasTypeT}),
  release_group:                  (
    {}: {[releaseGroupId: number]: ReleaseGroupT}),
  release_group_alias_type:       (
    {}: {[typeId: number]: ReleaseGroupAliasTypeT}
  ...
  script:                         ({}: {[scriptId: number]: ScriptT}),
  series:                         ({}: {[seriesId: number]: SeriesT}),
  series_alias_type:              ({}: {[typeId: number]: SeriesAliasTypeT}),
  series_ordering_type:           (
    {}: {[seriesOrderingTypeId: number]: SeriesOrderingTypeT}
  ),
  series_type:                    ({}: {[seriesTypeId: number]: SeriesTypeT}),
  url:                            ({}: {[urlId: number]: UrlT}),
  work:                           ({}: {[workId: number]: WorkT}),
  work_alias_type:                ({}: {[typeId: number]: WorkAliasTypeT}),
  work_attribute_type:            (
    {}: {[workAttributeTypeId: number]: WorkAttributeTypeT}
  ),
  work_type:                      ({}: {[workTypeId: number]: WorkTypeT}),
});
