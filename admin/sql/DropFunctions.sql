...
DROP FUNCTION a_del_l_area_area_mirror();
...
DROP FUNCTION a_del_release_group_secondary_type_join();
DROP FUNCTION a_del_release_label();
...
DROP FUNCTION a_ins_release_group_secondary_type_join();
DROP FUNCTION a_ins_release_label();
...
DROP FUNCTION a_upd_l_area_area_mirror();
...
DROP FUNCTION apply_artist_release_pending_updates();
DROP FUNCTION b_ins_edit_materialize_status();
DROP FUNCTION b_upd_artist_credit_name();
DROP FUNCTION b_upd_last_updated_table();
DROP FUNCTION b_upd_link();
DROP FUNCTION b_upd_link_attribute();
DROP FUNCTION b_upd_link_attribute_credit();
...
DROP FUNCTION integer_date(year SMALLINT, month SMALLINT, day SMALLINT);
