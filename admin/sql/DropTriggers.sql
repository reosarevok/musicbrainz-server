...
DROP TRIGGER end_date_implies_ended ON genre_alias;
DROP TRIGGER b_upd_genre_alias ON genre_alias;
DROP TRIGGER search_hint ON genre_alias;
...
DROP TRIGGER a_ins_l_area_area ON l_area_area;
DROP TRIGGER a_upd_l_area_area ON l_area_area;
DROP TRIGGER a_del_l_area_area ON l_area_area;
DROP TRIGGER b_upd_l_area_artist ON l_area_artist;
DROP TRIGGER b_upd_l_area_event ON l_area_event;
DROP TRIGGER b_upd_l_area_genre ON l_area_genre;
DROP TRIGGER b_upd_l_area_instrument ON l_area_instrument;
DROP TRIGGER b_upd_l_area_label ON l_area_label;
DROP TRIGGER b_upd_l_area_mood ON l_area_mood;
...
DROP TRIGGER b_upd_l_genre_genre ON l_genre_genre;
DROP TRIGGER b_upd_l_genre_instrument ON l_genre_instrument;
DROP TRIGGER b_upd_l_genre_label ON l_genre_label;
DROP TRIGGER b_upd_l_genre_mood ON l_genre_mood;
DROP TRIGGER b_upd_l_genre_place ON l_genre_place;
DROP TRIGGER b_upd_l_genre_recording ON l_genre_recording;
DROP TRIGGER b_upd_l_genre_release ON l_genre_release;
DROP TRIGGER b_upd_l_genre_release_group ON l_genre_release_group;
DROP TRIGGER b_upd_l_genre_url ON l_genre_url;
DROP TRIGGER b_upd_l_genre_work ON l_genre_work;
...
DROP TRIGGER b_upd_l_instrument_mood ON l_instrument_mood;
...
DROP TRIGGER b_upd_l_label_mood ON l_label_mood;
...
DROP TRIGGER b_upd_l_mood_mood ON l_mood_mood;
DROP TRIGGER b_upd_l_mood_place ON l_mood_place;
DROP TRIGGER b_upd_l_mood_recording ON l_mood_recording;
DROP TRIGGER b_upd_l_mood_release ON l_mood_release;
DROP TRIGGER b_upd_l_mood_release_group ON l_mood_release_group;
DROP TRIGGER b_upd_l_mood_url ON l_mood_url;
DROP TRIGGER b_upd_l_mood_work ON l_mood_work;
...
DROP TRIGGER b_upd_link ON link;
DROP TRIGGER b_ins_link_attribute ON link_attribute;
DROP TRIGGER b_upd_link_attribute ON link_attribute;
DROP TRIGGER b_upd_link_attribute_credit ON link_attribute_credit;
DROP TRIGGER b_upd_link_attribute_text_value ON link_attribute_text_value;
...
DROP TRIGGER b_upd_mood ON mood;
DROP TRIGGER end_date_implies_ended ON mood_alias;
DROP TRIGGER b_upd_mood_alias ON mood_alias;
DROP TRIGGER search_hint ON mood_alias;
...
DROP TRIGGER remove_unused_links ON l_area_genre;
DROP TRIGGER remove_unused_links ON l_area_label;
DROP TRIGGER remove_unused_links ON l_area_mood;
...
DROP TRIGGER remove_unused_links ON l_genre_genre;
DROP TRIGGER remove_unused_links ON l_genre_instrument;
DROP TRIGGER remove_unused_links ON l_genre_label;
DROP TRIGGER remove_unused_links ON l_genre_mood;
DROP TRIGGER remove_unused_links ON l_genre_place;
DROP TRIGGER remove_unused_links ON l_genre_recording;
DROP TRIGGER remove_unused_links ON l_genre_release;
DROP TRIGGER remove_unused_links ON l_genre_release_group;
DROP TRIGGER remove_unused_links ON l_genre_url;
DROP TRIGGER remove_unused_links ON l_genre_work;
DROP TRIGGER remove_unused_links ON l_instrument_instrument;
DROP TRIGGER remove_unused_links ON l_instrument_label;
DROP TRIGGER remove_unused_links ON l_instrument_mood;
...
DROP TRIGGER remove_unused_links ON l_label_mood;
...
DROP TRIGGER remove_unused_links ON l_mood_mood;
DROP TRIGGER remove_unused_links ON l_mood_place;
DROP TRIGGER remove_unused_links ON l_mood_recording;
DROP TRIGGER remove_unused_links ON l_mood_release;
DROP TRIGGER remove_unused_links ON l_mood_release_group;
DROP TRIGGER remove_unused_links ON l_mood_url;
DROP TRIGGER remove_unused_links ON l_mood_work;
...
DROP TRIGGER url_gc_a_upd_l_genre_url ON l_genre_url;
DROP TRIGGER url_gc_a_del_l_genre_url ON l_genre_url;
...
DROP TRIGGER url_gc_a_upd_l_mood_url ON l_mood_url;
DROP TRIGGER url_gc_a_del_l_mood_url ON l_mood_url;
