...
DROP TABLE artist_release_group_pending_update;
DROP TABLE artist_release_pending_update;
...
DROP TABLE l_genre_genre;
DROP TABLE l_genre_instrument;
DROP TABLE l_genre_label;
DROP TABLE l_genre_mood;
DROP TABLE l_genre_place;
DROP TABLE l_genre_recording;
DROP TABLE l_genre_release;
DROP TABLE l_genre_release_group;
DROP TABLE l_genre_series;
DROP TABLE l_genre_url;
DROP TABLE l_genre_work;
DROP TABLE l_instrument_instrument;
DROP TABLE l_instrument_label;
DROP TABLE l_instrument_mood;
...
DROP TABLE l_mood_mood;
DROP TABLE l_mood_place;
DROP TABLE l_mood_recording;
DROP TABLE l_mood_release;
DROP TABLE l_mood_release_group;
DROP TABLE l_mood_series;
DROP TABLE l_mood_url;
DROP TABLE l_mood_work;
