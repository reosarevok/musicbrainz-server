...
ALTER TABLE genre_alias_type DROP CONSTRAINT IF EXISTS genre_alias_type_pkey;
ALTER TABLE genre_annotation DROP CONSTRAINT IF EXISTS genre_annotation_pkey;
...
ALTER TABLE l_area_genre DROP CONSTRAINT IF EXISTS l_area_genre_pkey;
...
ALTER TABLE l_area_mood DROP CONSTRAINT IF EXISTS l_area_mood_pkey;
...
ALTER TABLE l_artist_genre DROP CONSTRAINT IF EXISTS l_artist_genre_pkey;
...
ALTER TABLE l_artist_mood DROP CONSTRAINT IF EXISTS l_artist_mood_pkey;
...
ALTER TABLE l_event_genre DROP CONSTRAINT IF EXISTS l_event_genre_pkey;
...
ALTER TABLE l_event_mood DROP CONSTRAINT IF EXISTS l_event_mood_pkey;
...
ALTER TABLE l_genre_genre DROP CONSTRAINT IF EXISTS l_genre_genre_pkey;
ALTER TABLE l_genre_instrument DROP CONSTRAINT IF EXISTS l_genre_instrument_pkey;
ALTER TABLE l_genre_label DROP CONSTRAINT IF EXISTS l_genre_label_pkey;
ALTER TABLE l_genre_mood DROP CONSTRAINT IF EXISTS l_genre_mood_pkey;
ALTER TABLE l_genre_place DROP CONSTRAINT IF EXISTS l_genre_place_pkey;
ALTER TABLE l_genre_recording DROP CONSTRAINT IF EXISTS l_genre_recording_pkey;
ALTER TABLE l_genre_release DROP CONSTRAINT IF EXISTS l_genre_release_pkey;
ALTER TABLE l_genre_release_group DROP CONSTRAINT IF EXISTS l_genre_release_group_pkey;
ALTER TABLE l_genre_series DROP CONSTRAINT IF EXISTS l_genre_series_pkey;
ALTER TABLE l_genre_url DROP CONSTRAINT IF EXISTS l_genre_url_pkey;
ALTER TABLE l_genre_work DROP CONSTRAINT IF EXISTS l_genre_work_pkey;
...
ALTER TABLE l_instrument_mood DROP CONSTRAINT IF EXISTS l_instrument_mood_pkey;
...
ALTER TABLE l_label_mood DROP CONSTRAINT IF EXISTS l_label_mood_pkey;
...
ALTER TABLE l_mood_mood DROP CONSTRAINT IF EXISTS l_mood_mood_pkey;
ALTER TABLE l_mood_place DROP CONSTRAINT IF EXISTS l_mood_place_pkey;
ALTER TABLE l_mood_recording DROP CONSTRAINT IF EXISTS l_mood_recording_pkey;
ALTER TABLE l_mood_release DROP CONSTRAINT IF EXISTS l_mood_release_pkey;
ALTER TABLE l_mood_release_group DROP CONSTRAINT IF EXISTS l_mood_release_group_pkey;
ALTER TABLE l_mood_series DROP CONSTRAINT IF EXISTS l_mood_series_pkey;
ALTER TABLE l_mood_url DROP CONSTRAINT IF EXISTS l_mood_url_pkey;
ALTER TABLE l_mood_work DROP CONSTRAINT IF EXISTS l_mood_work_pkey;
...
ALTER TABLE mood_alias_type DROP CONSTRAINT IF EXISTS mood_alias_type_pkey;
ALTER TABLE mood_annotation DROP CONSTRAINT IF EXISTS mood_annotation_pkey;
